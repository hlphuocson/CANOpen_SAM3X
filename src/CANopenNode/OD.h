...
********************************************************************************
    ...
    File info:
        ...
        Project File: DS301_profile - BK1_successfull_config_TPDO_RPDO.xpd
        File Version: 1

        Created:      12/29/2022 11:22:00 PM
        Created By:   HLPS
        Modified:     1/13/2023 8:31:51 AM
        Modified By:  

    Device Info:
        Vendor Name:  PMDST
        Vendor ID:    1704
        Product Name: Test_CANOpen_STM32F103C8T6
        Product ID:   154263
...
typedef struct {
    ...
    int8_t x6001_temperature;
    uint32_t x6003_speed;
} OD_RAM_t;
...
#define OD_ENTRY_H6000_velocity &OD->list[25]
#define OD_ENTRY_H6001_temperature &OD->list[26]
#define OD_ENTRY_H6003_speed &OD->list[27]
