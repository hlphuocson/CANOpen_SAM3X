...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1017_producerHeartbeatTime = 0x06F1,
    .x1018_identity = {
    ...
    .x1600_RPDOMappingParameter = {
        ...
        .applicationObject_1 = 0x60030020,
        .applicationObject_2 = 0x60000020
    },
    ...
    .x1A00_TPDOMappingParameter = {
        .numberOfMappedApplicationObjectsInPDO = 0x02,
        .applicationObject_1 = 0x60010008,
        .applicationObject_2 = 0x60000020
    },
...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x6001_temperature = 32,
    .x6003_speed = 0x00000400
};
...
typedef struct {
    ...
    OD_obj_var_t o_6001_temperature;
    OD_obj_var_t o_6003_speed;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6001_temperature = {
        .dataOrig = &OD_RAM.x6001_temperature,
        .attribute = ODA_SDO_RW | ODA_TRPDO,
        .dataLength = 1
    },
    .o_6003_speed = {
        .dataOrig = &OD_RAM.x6003_speed,
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6001, 0x01, ODT_VAR, &ODObjs.o_6001_temperature, NULL},
    {0x6003, 0x01, ODT_VAR, &ODObjs.o_6003_speed, NULL},
