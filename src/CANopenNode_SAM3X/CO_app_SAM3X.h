...
#ifndef CANOPENSAM3X_CO_APP_SAM3X_H_
#define CANOPENSAM3X_CO_APP_SAM3X_H_
 ...
 * and CANOpenSAM3X Driver will take of care of handling that
 ...
 * please note that CANOpenSAM3X Library will override HAL_TIM_PeriodElapsedCallback function, if you also need this function
...
typedef struct {
	 ...
	 * be the final NodeID, after calling canopen_app_init() you should check ActiveNodeID of CANopenNodeSAM3X structure for assigned Node ID.
	 */
    uint8_t activeNodeID; /* Assigned Node ID */
    uint32_t baudrate;     /* This is the baudrate you've set in your CubeMX Configuration */
    void*
        timerHandle; /*Pass in the timer that is going to be used for generating 1ms interrupt for tmrThread function,
	 * please note that CANOpenSAM3X Library will override HAL_TIM_PeriodElapsedCallback function, if you also need this function in your codes, please take required steps
	 */
...
// In order to use CANOpenSAM3X, you'll have it have a canopenNodeSAM3X structure somewhere in your codes, it is usually residing in CO_app_SAM3X.c
extern CANopenNodeSAM3X* canopenNodeSAM3X;
...
#endif /* CANOPENSAM3X_CO_APP_SAM3X_H_ */
